...
import { useAuth } from './AuthContext'; // useAuth'ı doğru dosyadan içe aktarın
  ...
  return (
    <div align='center' width='full' justifyContent='center'>
      <div className='LogOutglassCard'>
         ...
         <button onClick={handleConfirm} className="LogOut rounded-full hover:bg-green-700">Evet, çıkış yap</button>
         <Link to='/WeatherApp'><button onClick={handleCancel} className="LogOut rounded-full mb-12 hover:bg-green-700">Hayır, kal</button></Link>
      </div>
    </div>
  );
};

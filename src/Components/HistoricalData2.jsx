...
const HistoricalData2 = () => {
    ...
    return (
        <div>
            ...
            <div>
               <Link to={`/HistoricalDataMonth2`} className="hover:bg-green-700 text-white font-bold py-2 px-4 rounded button">View Monthly Data</Link>
            </div>
        </div>
    );
};

export default HistoricalData2;
